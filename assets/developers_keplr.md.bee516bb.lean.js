...
`),J,n(`
`),s("span",Z,[s("span",L,"  rpc: '"+l(a.constants.mainnetRpcUrl)+"',",1)]),n(`
...
`),Os,n(`
`),s("span",Ys,[s("span",Xs,"  rpc: '"+l(a.constants.arabicaRpcUrl)+"',",1)]),n(`
`),s("span",zs,[s("span",Qs,"  rest: '"+l(a.constants.arabicaRestUrl)+"'",1)]),n(`
`),Ws,n(`
`),Js,n(`
`),Zs])]),s("pre",Ls,[s("code",null,[$s,n(`
`),sn,n(`
`),nn,n(`
